  ...
  return (
    <div className="relative pt-16 pb-10 sm:pt-16 sm:pb-16 lg:pb-18 overflow-hidden h-[92vh]">
      ...
      <div className="relative bottom-0 z-10 flex mx-auto justify-center">
        <img
          className="left-[-20px] top-[-20px] sm:left-20 sm:top-[-200px] absolute block w-auto h-[150px] sm:h-[500px]"
          src={notebookL}
          alt=""
        />
        <img
          className="absolute sm:relative w-auto bottom-[-110px] right-[-70px] sm:bottom-0 sm:right-0 h-[100px] sm:h-[380px]"
          src={notebookM}
        />
        <img
          className="right-0 sm:bottom-0 absolute block h-auto w-[800px] sm:w-[900px]"
          src={profilepic}
          alt=""
        />
      </div>
