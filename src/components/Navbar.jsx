...
const Navbar = () => {
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 mx-auto max-w-[1500px] h-[8vh]">
      <div className="flex items-center justify-between justify-between h-16 lg:h20 bg-[#223]/30 rounded-b-3xl shadow-lg px-4">
        <div className="text-white text-xl sm:text-2x1">
          <a href="#" className="font-bold">
            <span>Xavi Arnau</span>
          </a>
        </div>
