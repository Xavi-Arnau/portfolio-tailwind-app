      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 bg-[#223]/30 rounded-3xl">
        <div class="mb-4">
          <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto ">
            <h2 class="mb-4 font-bold tracking-tight gray-primary-color text-3xl sm:text-5xl">
              Let´s connect
            </h2>
        ...
        <div class="flex justify-center">
          <div class="grid md:grid-cols-2">
            <div class="my-auto pr-6">
              <ul>
                ...
                <li class="flex items-center">
                  ...
                  <div class="m-5">
                    <h3 class="text-lg font-bold text-gray-200">Contact</h3>
            ...
            <div class="max-w-6xl p-5 md:p-12" id="form">
              ...
              <form action="https://getform.io/f/zazoknmb" method="POST">
                <div class="mb-6">
